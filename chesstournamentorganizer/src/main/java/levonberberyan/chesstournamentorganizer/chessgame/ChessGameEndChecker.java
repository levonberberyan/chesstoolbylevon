...
import levonberberyan.chesstournamentorganizer.chessenginesession.ChessEngine;
...
public class ChessGameEndChecker {
	 ...
	 */
	public static GameStatesEnum checkIsEndOfGameUsingStockfish(ChessGame theChessGameState){ //result is: normalMove or checkmate or stalemate
		...
		ChessEngine aChessEngine = new ChessEngineAsProcess();
